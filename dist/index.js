...
var PlainValue = __nccwpck_require__(215);
var resolveSeq = __nccwpck_require__(227);
var Schema = __nccwpck_require__(21);
...
var PlainValue = __nccwpck_require__(215);
var resolveSeq = __nccwpck_require__(227);
var warnings = __nccwpck_require__(3);
...
var Document$1 = __nccwpck_require__(506);
var Schema = __nccwpck_require__(21);
var PlainValue = __nccwpck_require__(215);
var warnings = __nccwpck_require__(3);
...
module.exports = __nccwpck_require__(65).YAML
...
if (!globalThis.ReadableStream) {
  try {
    Object.assign(globalThis, __nccwpck_require__(81))
  } catch (error) {
...
const run = async () => {
  try {
    ...
    let publicationsYml = yaml_default().stringify(publications);
